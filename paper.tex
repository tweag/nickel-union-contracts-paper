...
In these practical gradual type systems the problem is to be able to
capture, in static types, as many programming patterns as possible
from the underlying dynamically typed language. One such pattern is
heterogeneous collections, in JavaScript (for TypeScript) and Python
(for MyPy), heterogeneous collections, say arrays with values of
different types, are frequent. For instance, in TypeScript, an array
