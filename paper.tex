...
function). Beside, many languages out there already feature non-termination. For
such langauges, adding contracts does not change what optimizations are valid.
