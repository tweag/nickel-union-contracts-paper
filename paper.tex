...
there is no hesitation in incorporating recent research or doing it ourselves,
the design decisions are always guided by the practical industrial use cases.
...
inference properties, that make typing functions operating on generic data easy,
