...
Keil and Thiemann~\cite{KeilThiemannUnionIntersection}
...
\citeauthor{KeilThiemannUnionIntersection}'s coinductive semantics
rejects it as a contract violation.
This can be phrased pithily as the fact that the
...
Section~\ref{sec:coinductive-sem}.
Nevertheless, Keil and Thiemann~\cite{KeilThiemannUnionIntersection}
give an algorithmic system which
...
To implement contract verification,
Keil and Thiemann~\cite{KeilThiemannUnionIntersection} resort to
...
The consequence is that Williams et al.~\cite{RootCauseOfBlame} don't
prove their system complete for the coinductive semantics.
