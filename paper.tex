...
\acmConference[DLS 2021]{Dynamic Languages Symposium}{October
17--22}{Chicago, Illinois, United States}
...
model, augmented with abstraction mechanisms, and it's conformed of:
...
(\ref{eq:cbn-expansion}) \emph{unsound}\footnote{(\ref{eq:cbn-expansion}) holds
  even in a technically impure language like Nickel with non-termination and
  higher-order contracts because of lazy evaluation. This is not the case in a strict language,
  although in that case, (\ref{eq:cbn-expansion}) still holds more often without
  unions and intersections than with.}, preventing the kind of optimization of
...
positive numbers to positive numbers nor positive numbers to non positive numbers.
...
language. It's probably more manageable, and it's the approach taken
by Nickel to be able to logically combine contracts.
