...
opinion, are the most salient flaws and their consequences. Even in a pure
language, union and intersection contracts break the equivalence between
call-by-name and call-by-value, and consequently can prevent CSE-like
...
the theoretical framework, a proof-of-concept, a prototype, and the integration
in an actual language. We hope that our attempt may serve as a cautionary tale,
that for union and intersection contracts, these gaps are sometimes large in
places.
