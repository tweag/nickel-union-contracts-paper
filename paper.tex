...
corresponding label in the environment. But the most surprising\todo{(Yann) find
another word} part is that for contracts attached to a function that is applied,
...
environment!\todo{(Yann) TBC: find better wording} 
