...
\keywords{Dynamic languages, Contracts, Union, Intersection}
...
lean\todo{Not the right word} semantics for union and intersection contracts. We
follow with the work Williams, Morris, and Wadler~\cite{RootCauseOfBlame} which
builds upon~\cite{KeilThiemannUnionIntersection} and introduces a simpler, more
...
Section 5.1 of \cite{KeilThiemannUnionIntersection}} (contracts are incompatible
...
linking the operational semantics to the denotational semantics doesn't
correspond to its attached description.
